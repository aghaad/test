    ...
    public function MailConfirmation($reservation,$billets)  {
        ...
        $mail = new PHPMailer(true);                              // Passing `true` enables exceptions
            try {
                ...
                $mail->Host = ' free.gmail.com';  // Specify main and backup SMTP servers
                ...
                //Recipients
                $mail->setFrom('greta.a.amrani@free.fr', 'reservations');
                $mail->addAddress('greta.a.amrani@free.fr', 'aghaad');     // Add a recipient
                $mail->addAddress('le.musee.du.louvre.75@gmail.com');               // Name is optional
                $mail->addReplyTo('greta.a.amrani@free.fr', 'Information');
